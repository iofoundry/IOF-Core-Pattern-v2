...
\cname{ns}{GPSTimeDescription} class has a temporal reference system as \iname{ns}{GPSTimeSystem}, which refers to the specification of the GPS time format. Following the standard, a \cname{}{GPSTimeDescription} has a 
