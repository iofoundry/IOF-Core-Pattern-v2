...
% Instruction box
\textit{ 
This scenario demonstrates how to represent the material composition of objects using the BFO and IOF core. The pattern addresses the common industrial need to track what materials objects are made of.
