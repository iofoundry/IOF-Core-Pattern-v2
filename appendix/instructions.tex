...
\begin{enumerate}
    \item \textbf{Namespace:} Every label of ontological terms that are used in a diagram or text must accompany a namespace. Only a namespace prefix should be used, e.g., \cname{bfo}{Occurrent}. The prefixes should be common across all diagrams and text and should be declared in the front matter. 
        \begin{enumerate}
...
Data Property (\cname{rdf}{DatatypeProperty}) & 
...
& It is better to use the label (\anno{rdf}{Label}) of the property for better comprehension. If the original \anno{rdf}{Label} has spaces, they should be removed to convert to camelCase. \\
& Example: \dpname{iof}{hasSimpleExpressionValue}. \\ \hline
